            ...
            <div class="card-body p-md-2">
              <div class="row justify-content-center">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-2" action="add.php" method="post" onsubmit="return validateForm()" novalidate>
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Register" name="register" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600; background-color: #86469C;" />
                    </div>
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  ...
                  <img src="signuppic.png" class="img-fluid" alt="Sample image" height="300px" width="500px">
